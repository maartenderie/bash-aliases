...
alias sspmr='ssh sd_production_morpheus'
...
alias sspcy='ssh sd_production_cypher'
alias ssph='ssh sd_production_hyperion'
alias sspd='ssh sd_production_dujour'
alias sspy='ssh sd_production_yoda'
alias sspa='ssh sd_production_apoc'
alias sspi2='ssh sd_production_internal2'
